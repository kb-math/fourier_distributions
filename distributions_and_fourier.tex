...
\begin{mydef} For integers $k \geq 0$ and $\Omega \subset \bR^d$ open, we define the \textit{Sobolev space} $H^k(\Omega)$ denote the space of those $u \in L^2(\Omega)$ such that whenever $|\alpha| \leq k$ then the distribution $D^{\alpha}u$ is an element off $L^2(\Omega)$.
